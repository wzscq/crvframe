...
import {RSAEncrypt} from '../../../../../utils/passwordEncoder';
...
export default function RSAEncryptText({dataPath,control,field}){
    ...
    const onChange=(e)=>{
        let encrytedValue=e.target.value;
        if(encrytedValue){
            encrytedValue=RSAEncrypt(encrytedValue,control.publicKey);
        }
