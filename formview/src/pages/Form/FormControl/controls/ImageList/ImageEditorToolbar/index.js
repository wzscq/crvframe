...
export default function getToolbar({drawShapeType,setDrawShapeType,getDataUrl,strokeColor,setStrokeColor,fontSize,setFontSize,strokeWidth,setStrokeWidth,rollback}) {
