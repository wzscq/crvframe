...
export default function LoginForm({appID,clientID,redirectUri}){
    ...
    const onFinish = (values) => {
        //提交账号密码，获取用户token
        const loginParam={...values,clientID:clientID,redirectUri:redirectUri,password:encodePassword(values.password),appID:appID};
        dispatch(oauthLoginApi(loginParam));
    };
