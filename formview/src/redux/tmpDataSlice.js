...
//全局唯一索引用于新建数据行的key值
var gTmpRowIdx=0;
const defaultRowKey='__c__'+gTmpRowIdx++;
...
export const tmpDataSlice = createSlice({
    name: 'tmpdata',
    initialState,
    reducers: {
...
export const { 
    ...
    refreshData,
    initData
} = tmpDataSlice.actions

export default tmpDataSlice.reducer